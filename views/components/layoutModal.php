...
<div class="modal modal-xl fade" id="layoutModal" tabindex="-1" aria-labelledby="layoutModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-bg-light text-dark shadow-lg rounded-3">
            ...
            <!-- Modal Body -->
            <div class="modal-body text-center" id="layoutModalBody">
                ...
                <div class="d-flex justify-content-center mb-4">
                    ...
                    <div class="d-flex align-items-center mx-4">
                        ...
                        <div class="seat border border-success border-3"></div>
                    </div>

                    <div class="d-flex align-items-center mx-4">
                        <span>Business Class</span>
                        <div class="seat border border-danger border-3"></div>
                    </div>

                    <div class="d-flex align-items-center mx-4">
                        <span>Economy Class</span>
                        <div class="seat border border-warning border-3"></div>
                    </div>
